...
# Define callbacks with a more aggressive learning rate scheduler and reduced patience
...
# Train the model with more epochs and batch size tuning
history = model.fit(
    X_train_scaled, y_train,
    epochs=1000, batch_size=16,  # Smaller batch size can sometimes lead to faster convergence
