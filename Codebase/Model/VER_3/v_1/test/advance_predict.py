...
def dual_frequency_optimization(initial_params, freq1, freq2):
    ...
    def objective(x):
        ...
        # Concatenate to get a flat array of 4 elements
...
def plot_performance(initial_params, optimized_params, freq1, freq2):
    ...
    plt.plot([freq1, freq2], [optimized_params[0], optimized_params[0]],
             marker='o', label='l_s vs Freq')
    plt.plot([freq1, freq2], [optimized_params[5], optimized_params[5]],
             marker='s', label='w_s vs Freq')
    plt.xlabel('Frequency (MHz)')
    plt.ylabel('Parameter Value')
    plt.title('Parameter-Frequency Relationship')
    plt.legend()
...
def main():
    ...
    if mode == "dual":
        ...
        try:
            ...
            # Initial predictions using base_params + frequency
            ...
            # Pass just the design parameters (8 numbers) to plot_performance.
